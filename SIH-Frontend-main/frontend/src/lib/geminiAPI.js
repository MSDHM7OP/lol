 ...
 * 
 * ⚠️ SECURITY NOTE: For production, API keys should be stored in backend only
 * and accessed through secure proxy endpoints. Never commit real API keys to git.
 * This implementation supports both:
 * 1. Backend proxy: Call /api/ai/gemini endpoint (recommended)
 * 2. Fallback: Use local key if configured (development only)
 */
